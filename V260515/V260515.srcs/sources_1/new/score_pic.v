...
//--------------------------------------------
// segment pixel - 함수 없이 wire로 직접 계산
//--------------------------------------------
wire [6:0] s0 = seg7(d3);
wire [6:0] s1 = seg7(d2);
wire [6:0] s2 = seg7(d1);
...
wire seg0 = in0 && (
    (s0[0] && (ly <  T)  && (lx0 <  R))                        ||
    (s0[1] && (lx0 <  T) && (ly <  M1))                        ||
    (s0[2] && (lx0 <  T) && (ly >= M2) && (ly < B))            ||
    (s0[3] && (ly >= B)  && (lx0 <  R))                        ||
    (s0[4] && (lx0 >= R-T) && (ly >= M2) && (ly < B))          ||
    (s0[5] && (lx0 >= R-T) && (ly <  M1))                      ||
    (s0[6] && (ly >= M1) && (ly < M2) && (lx0 < R))
);
...
wire seg1 = in1 && (
    (s1[0] && (ly <  T)  && (lx1 <  R))                        ||
    (s1[1] && (lx1 <  T) && (ly <  M1))                        ||
    (s1[2] && (lx1 <  T) && (ly >= M2) && (ly < B))            ||
    (s1[3] && (ly >= B)  && (lx1 <  R))                        ||
    (s1[4] && (lx1 >= R-T) && (ly >= M2) && (ly < B))          ||
    (s1[5] && (lx1 >= R-T) && (ly <  M1))                      ||
    (s1[6] && (ly >= M1) && (ly < M2) && (lx1 < R))
);
...
wire seg2 = in2 && (
    (s2[0] && (ly <  T)  && (lx2 <  R))                        ||
    (s2[1] && (lx2 <  T) && (ly <  M1))                        ||
    (s2[2] && (lx2 <  T) && (ly >= M2) && (ly < B))            ||
    (s2[3] && (ly >= B)  && (lx2 <  R))                        ||
    (s2[4] && (lx2 >= R-T) && (ly >= M2) && (ly < B))          ||
    (s2[5] && (lx2 >= R-T) && (ly <  M1))                      ||
    (s2[6] && (ly >= M1) && (ly < M2) && (lx2 < R))
);
...
wire seg3 = in3 && (
    (s3[0] && (ly <  T)  && (lx3 <  R))                        ||
    (s3[1] && (lx3 <  T) && (ly <  M1))                        ||
    (s3[2] && (lx3 <  T) && (ly >= M2) && (ly < B))            ||
    (s3[3] && (ly >= B)  && (lx3 <  R))                        ||
    (s3[4] && (lx3 >= R-T) && (ly >= M2) && (ly < B))          ||
    (s3[5] && (lx3 >= R-T) && (ly <  M1))                      ||
    (s3[6] && (ly >= M1) && (ly < M2) && (lx3 < R))
);
