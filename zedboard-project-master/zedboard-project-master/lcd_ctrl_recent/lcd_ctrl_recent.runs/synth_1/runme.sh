...
HD_PWD='C:/Users/USER/Downloads/zedboard-project-master/zedboard-project-master/lcd_ctrl_recent/lcd_ctrl_recent.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_colorbar_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_colorbar_top.tcl
